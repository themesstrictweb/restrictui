---
title: Installation
description: This guide will help you get started with ReStrictUI's copy-and-paste components in just a few minutes.
---

## Prerequisites

Before you can install and use ReStrictUI, make sure your project meets the following requirements:
...
ReStrictUI is fully compatible with Shadcn and extends it with advanced component options.
...
> ✅ For a modern and visually appealing design, we recommend using [Inter](https://fonts.google.com/specimen/Inter) as
    ...
    the default font in your ReStrictUI project.
...
Explore the [ReStrictUI Components](/docs/accordion) and add the ones you need into your project.
