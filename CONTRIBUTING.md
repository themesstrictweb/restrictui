# Contributing to ReStrictUI

Thank you for considering contributing to restrictui! Your contributions help improve the project for everyone.
Please follow these guidelines to ensure a smooth collaboration. 
If you need any help, feel free to reach out us via [@restrictui_io](https://x.com/restrictui_io).
...
2. **Clone Your Fork**:
   ```sh
   git clone https://github.com/themesstrictweb/restrictui.git
   cd restrictui
   ```
3. **Set Up Upstream Remote**:
   ```sh
   git remote add upstream https://github.com/themesstrictweb/restrictui.git
   ```
...
4. Open a pull request:
   - Go to the [restrictui GitHub repository](https://github.com/themesstrictweb/restrictui.git).
   - Click on 'New Pull Request'.
   - Select your branch and submit the PR.

## Code Review

Code is reviewed under strict terms to make sure it matches restrictui code standards and design guidelines.
